...
type AppView = 'site' | 'classroom' | 'safety' | 'statslab' | 'walkthrough';

type DataPulseView = 'classroom' | 'safety' | 'statslab';
...
function App() {
  ...
  useEffect(() => {
    const title = isSafetyDomain ? 'Safety App' : isEduSyncDomain ? 'EduSync' : 'DATAPULSE SOCIAL';
