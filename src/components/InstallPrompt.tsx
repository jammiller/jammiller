          ...
          <div className="bg-navy-900 rounded-2xl shadow-2xl border border-gold-500/30 overflow-hidden">
            <div className="flex items-start gap-3 p-4">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-white font-semibold text-sm">Install EduSync</h4>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200">
              <h3 className="font-bold text-navy-900 text-base">Install EduSync</h3>
              <button
                onClick={dismissModal}
            ...
            <div className="p-5 space-y-5">
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-xs mt-0.5 leading-relaxed">
                    The EduSync icon will appear on your home screen. Tap it anytime to open the app.
                  </p>
                </div>
              </div>
            </div>
