      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto leading-relaxed">
            DATAPULSE SOCIAL was founded with one mission: to make exceptional education accessible and achievable for every institution.
          </p>
        </div>

        <div className="max-w-3xl mx-auto text-center mb-16">
          <p className="text-slate-600 leading-relaxed mb-6">
            We believe the best learning experiences don't happen by accident — they're carefully designed. Our team combines deep expertise in instructional design, content strategy, and educational technology to help you build programs that work.
          </p>
