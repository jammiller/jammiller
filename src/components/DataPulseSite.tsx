...
import { insiderPrompts, insiderCategories, insiderTrends, insiderTrainings, insiderOptimizationSessions, insiderResources, insiderTemplates } from '../data/insiderContent';
