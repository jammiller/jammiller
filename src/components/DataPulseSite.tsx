...
type AppView = 'classroom' | 'safety' | 'statslab';
          ...
          <div className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-24 sm:px-6 sm:py-32 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-8">
            <div>
              ...
              <h1 className="max-w-3xl text-4xl font-bold leading-tight tracking-tight sm:text-6xl">
                Turn expertise into <span className="text-gold-400">learning that lasts.</span>
              </h1>
              <p className="mt-6 max-w-xl text-base leading-relaxed text-slate-300 sm:text-lg">
                DATAPULSE SOCIAL helps educators, institutions, and organizations design clear, engaging learning programs that move people forward.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl border border-white/15 bg-white/[0.07] p-6 shadow-2xl backdrop-blur-sm sm:p-8">
                ...
                <div className="space-y-5">
                  {['Structure the journey', 'Create moments that matter', 'Measure meaningful progress'].map((item, index) => (
                    <div key={item} className="flex items-center gap-4">
                      <span className="flex h-8 w-8 items-center justify-center rounded-full border border-gold-400/50 text-xs font-bold text-gold-300">0{index + 1}</span>
                ...
                <div className="mt-8 rounded-2xl bg-white/10 p-4">
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-slate-200">Practical strategy, thoughtful design, and content people can actually use.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="services" className="bg-softgray py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-14 max-w-2xl">
              ...
              <p className="mt-4 leading-relaxed text-slate-600">From the first learning objective to the final assessment, we bring structure and momentum to the entire experience.</p>
            </div>
        ...
        <section id="contact" className="blueprint-overlay relative overflow-hidden bg-navy-950 py-20 text-white">
          <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-8 px-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
              <a href="mailto:info@datapulsesocial.com" className="inline-flex items-center justify-center gap-2 rounded-xl bg-gold-500 px-5 py-3 text-sm font-semibold text-navy-950 transition-colors hover:bg-gold-400"><Mail className="h-4 w-4" /> Email us</a>
