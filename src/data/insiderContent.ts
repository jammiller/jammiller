...
export const insiderTrainings: InsiderTraining[] = [
  ...
  },
  {
    ...
    link: 'https://blog.hubspot.com/marketing/social-media-strategy-for-your-business',
    linkLabel: 'Open link',
  },
  {
    ...
    category: 'Content Creation',
    type: 'Guide',
    description: 'A comprehensive 2026 guide to free social media marketing courses with certificates, covering social SEO, video formats, and content repurposing workflows.',
    summary: 'This resource lists free certified courses that break down current operational tactics including social SEO captioning, long-form video, and cross-platform repurposing. It demonstrates how to transition vanity metrics into bottom-line conversions and social commerce sales.',
    link: 'https://uniathena.com/free-social-media-marketing-courses',
    linkLabel: 'Open link',
  },
  {
...
export const insiderResources: InsiderResource[] = [
  {
    ...
    link: 'https://blog.hubspot.com/marketing/marketing-tools',
    linkLabel: 'Open resource',
  },
  {
    id: 'free-marketing-tools-2026',
    title: '20 Free Advertising Tips for Your Small Business',
    type: 'Tool List',
    category: 'Content',
    description: 'Curated selection of zero-cost advertising and marketing tips covering local listings, networking, community partnerships, and free promotional channels for small teams.',
    link: 'https://blog.hubspot.com/marketing/free-advertising',
    linkLabel: 'Open resource',
  },
  {
    id: 'free-html-email-templates',
    title: 'Free Email Templates for Your Marketing Campaigns',
    type: 'Template',
    category: 'Email Marketing',
    description: 'A collection of customizable, responsive email templates designed for outreach campaigns, newsletters, and lead follow-ups.',
    link: 'https://blog.hubspot.com/marketing/email-templates',
    linkLabel: 'Open resource',
  },
  {
    ...
    link: 'https://blog.hubspot.com/marketing/small-business-marketing-guide',
    linkLabel: 'Open resource',
  },
  {
